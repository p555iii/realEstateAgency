...
import com.real.cyd.google.BufferedImageLuminanceSource;
import com.real.cyd.google.MatrixToImageWriter;

public class QRCodeEvents {

    public static void main(String[] args) {

        //String text = generateNumCode(100);  //随机生成的12位验证码
        String text = "https://192.168.43.1/QRcord";
        //System.out.println("随机生成的100位验证码为： " + text);
